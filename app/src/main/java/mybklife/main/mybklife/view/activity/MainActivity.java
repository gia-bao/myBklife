...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // FloatingActionButton fab=(FloatingActionButton) fi
        ...
        displaySelectedScreen(R.id.nav_TodayMenu);
    }
    ...
    private void displaySelectedScreen(int itemId){
        ...
        switch(itemId){
            case R.id.nav_TodayMenu:
                fragment=new TodayMenu();
                break;
            case R.id.nav_ClassMenu:
                fragment=new ClassMenu();
                break;
            case R.id.nav_ExamMenu:
                fragment=new ExamMenu();
                break;
            case R.id.nav_AssignmentMenu:
